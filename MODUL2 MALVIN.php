...
$tinggiBadanInput = $_GET['tinggi_badan']?$_POST['tinggi_badan']:'';
$beratBadan = $_GET['berat_badan']?$_POST['berat_badan']:'';
...
// silakan taruh code kalian di bawah
if($tinggiBadanInput = 0 || $tinggibadan = '' || $beratBedan = 0 || $beratBadanMax = ''){
...
// silakan taruh code kalian di bawah
if(isset($submit)){
    $tinggiBadan = $tinggiBadanInput/100;
    $hitung = $beratBadan / ($tinggiBadan * $tinggiBadan);
    $result  = number_format($hitung);
}elseif ($result <= 18.4){
    $status ="Underweight";
}elseif ($result >= 18.5 and $result<= 24.9 ){
    $status = "Normal";
}elseif ($result >= 25.0 and $result <= 39.9 ){
    $status = "Overweight";
}elseif ($result>= 40){
    $status = "Obese";
}
